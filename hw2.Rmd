...
length(topTable1$Probe_Id)  ## number of responsive probes
...
Select subset of expression matrix corresponding to differentially expressed probes and plot heatmap.
